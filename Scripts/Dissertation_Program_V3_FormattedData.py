...
FER_cycle, FER_trend = sm.tsa.filters.hpfilter(FER,129600)
SER_cycle, SER_trend = sm.tsa.filters.hpfilter(SER,129600)
XX_cycle, XX_trend = sm.tsa.filters.hpfilter(XX,129600)
YY_cycle, YY_trend = sm.tsa.filters.hpfilter(YY,129600)
MM_cycle, MM_trend = sm.tsa.filters.hpfilter(MM,129600)
NN_cycle, NN_trend = sm.tsa.filters.hpfilter(NN,129600)
